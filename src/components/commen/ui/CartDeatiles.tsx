  ...
  return (
    <ul className="d-grid gap-2">
      ...
      <li className="flex-items gap-1">
        ...
        <p className="fs-px_16 fw-medium ln-ht-27px flex-1">{cardNumber}</p>
      </li>
      <li className="flex-items gap-1">
        <p className="fw-normal fs-px_14 ln-ht-17px flex-1">Nom sur la carte</p>
        <p className="fs-px_16 fw-medium ln-ht-27px flex-1">{cardHolderName}</p>
      </li>
      <li className="flex-items gap-1">
        <p className="fw-normal fs-px_14 ln-ht-17px flex-1">Date de validité</p>
        <p className="fs-px_16 fw-medium ln-ht-27px flex-1">{expiryDate}</p>
      </li>
      <li className="flex-items gap-1">
        <p className="fw-normal fs-px_14 ln-ht-17px flex-1">CVV</p>
        <p className="fs-px_16 fw-medium ln-ht-27px flex-1">{cvv}</p>
      </li>
    </ul>
  );
};
