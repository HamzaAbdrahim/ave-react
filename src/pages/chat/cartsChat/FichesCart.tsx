...
const FichesCart = () => {
  ...
  return (
    <div >
    <div onClick={handleToggle} className="flex-items cursor-pointer cursor-pointer
     rounded-corners_1rem justify-content-between py-3 bg-white px-4">
